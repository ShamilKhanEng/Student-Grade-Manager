...
public class SelectorPage extends AppCompatActivity implements View.OnClickListener {
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.menu_logout:
                firebaseDatabaseManager.signOut();
    ...
    public void onClick(View vSelector) {
        if (vSelector.getId() == R.id.GradCalBTn) {
            ...
            firebaseDatabaseManager.getStudentData(userID, new ValueEventListener() {
                @Override
    ...
    public void createNewContactDialog() {
        ...
        mainPopUpClose = contactPopupView.findViewById(R.id.mainMenuBtnClose);
