...
import com.example.studenthub.Strategy.MinEndMarksStrategy;
import com.example.studenthub.Strategy.MinGPAStrategy;
import com.example.studenthub.Strategy.StrategyContext;
                    ...
                    if(TextUtils.isEmpty(CurrentCumGPAStr)){
                        ...
                        for(String key:GPAmapMarks.keySet()){
                            ...
                            if(ExpectFinalGPAStr.equals(key)){
                                ...
                                strategy = new StrategyContext(new MinGPAStrategy());
                                strategy.setTotalSemCountStr(TotalSemCountStr);
                                strategy.setCurrentSemStr(CurrentSemStr);
                                strategy.setKey(key);
                                strategy.setCurrentCumGPAStr(CurrentCumGPAStr);



                                MinExpectedSemGPA.setText(strategy.executeStrategy());
                    ...
                    if(TextUtils.isEmpty(ExpectSemGPAStr)){
                        ...
                        for(String key:GPAmapMarks.keySet()){
                            ...
                            if(ExpectSemGPAStr.equals(key)){
                                ...
                                strategy = new StrategyContext(new MinEndMarksStrategy());
                                strategy.setCourseAssignMarksStr(CourseAssignMarksStr);
                                strategy.setCourseLabMarksStr(CourseLabMarksStr);
                                strategy.setCourseMidMarksStr(CourseMidMarksStr);
                                strategy.setCourseProjectStr(CourseProjectStr);


                               int reqEndMarks=Integer.parseInt(strategy.executeStrategy());
